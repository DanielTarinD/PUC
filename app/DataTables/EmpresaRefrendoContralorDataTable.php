...
class EmpresaRefrendoContralorDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->editColumn('empresa.nombre_empresa', function($data) {
            ...
            ->editColumn('empresa.nombre_persona', function($data) {
            ...
            ->addColumn('validaciones', function($data){
            ...
            ->editColumn('refrendo', function($data) {
            ...
            ->addColumn('action', function($data){
                    ...
                    $actionBtn =  "<a href='/contralor/refrendos/".$refrendoId."' class='btn btn-xs btn-info w-60px me-1' id='acceso' data-id='".$refrendoId."'>Revisar</a>";
    ...
    public function query(Refrendo $model)
    {
        ...
        return  $model->without('observacionesRefrendos')->with('empresa')->whereHas('empresa.especialidades', function($q) {
            $q->where('ejercicio', '=', '2024');
