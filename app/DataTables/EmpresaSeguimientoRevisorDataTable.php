...
class EmpresaSeguimientoRevisorDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->editColumn('updated_at', function(Empresa $data) {
                return  Carbon::parse($data->observaciones->updated_at)->format('d-m-Y');
            })
            ...
            ->editColumn('estatus', function(Empresa $data) {
                ...
                switch ($data->estatus) {
                    case 'N':
                            return "<span class='badge bg-secondary'>Nueva</span>";
                        break;
                    case 'R':
            ...
            ->addColumn('action', function(Empresa $data){
                ...
                if($data->estatus == 'V' || $data->estatus == 'O'){
                    $actionBtn =  "<a href='/revisor/empresas/ver/".$data->id."' class='btn btn-xs btn-secondary w-60px me-1' id='acceso' data-id='".$data->id."'><i class='fa fa-eye'></i></a>";
    ...
    public function query(Empresa $model)
    {
        ...
        ->whereRelation('observaciones', 'obras_id', $user->id);
    }
