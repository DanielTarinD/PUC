...
class EmpresaRefrendoRevisorDataTable extends DataTable
{
    ...
    public function query(Refrendo $model)
    {
        ...
        return $model->where('refrendos.estatus', 'N')->with('empresa:id,rfc_empresa,nombre_empresa,nombre_persona')->select('refrendos.*')->newQuery();
