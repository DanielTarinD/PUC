...
class storeEmpresa extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'rfc_empresa' => 'required|unique:empresas',
            'user_id' => 'required',
            'tipo' => 'required',
            'motivo_empresa' => 'required',
            'enlace_refrendo'=>'required_if:motivo_empresa,2',
    ...
    public function attributes()
    {
        return [
            'user_id' => 'Usuario',
            'tipo' => 'Tipo',
            'motivo_empresa' => 'Tipo de Registro',
            'enlace_refrendo' => 'Enlace al Refrendo o Inscripción del año anterior',
    ...
    public function messages()
    {
        return [
            ...
            'enlace_refrendo.required_if' => 'El enlace al Refrento o Inscripción del año anterior es obligatorio',
        ];
    }
}
