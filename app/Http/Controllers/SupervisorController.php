...
class SupervisorController extends Controller
{
    ...
    {
        $user = auth()->user();
        return view('supervision.empresas.index');
    }
    ...
    {
        $user = auth()->user();
        return view('supervision.empresas.indexRefrendos');
    }
    ...
    public function ver($id)
    {
        ...
        if($empresa = Empresa::find($id)){
            ...
            return view('supervision.empresas.ver')->with(compact('empresa'));
        }
    ...
    public function verRefrendos($id)
    {
        ...
        if($refrendo = Refrendo::find($id)){
            ...
            return view('supervision.refrendos.ver')->with(compact('refrendo'));
        }
    ...
    public function constancia(storeConstancia $request)
    {
        ...
        $ejercicio = $request->ejercicio_folio_jefatura;

        $ejercicioFolioPadron = $request->ejercicio_folio;
        ...
        if($empresa->folio()->count() > 0){
            ...
            if($request->hasFile('file')){
             ...
             // Modificacion para el Cambio de Ejercicio del Folio Unico del Padrón

            $folio->folio = substr_replace($folio->folio, $ejercicioFolioPadron, -4);
            ...
            return redirect()->route('supervision.ver', ['id' => $empresa->id]);
        }
...
/*
        ...
        try{
            ...
            return redirect()->route('supervision.ver.refrendos', ['id' => $refrendo->id])->withErrors(['mensaje'=>'Hubo un problema al enviar el correo. Notifique al Contratista directamente.']);

        }

*/
        return redirect()->route('supervision.ver.refrendos', ['id' => $refrendo->id]);
    ...
    public function cambiarEstatus(Request $request)
    {
        ...
        $empresa->update(['motivo_empresa'=> $request->motivo_empresa]);
    ...
    public function cambiarEstatusRefrendo(Request $request)
    {
