...
<script type="text/javascript">
    $(function () {
            ...
            var table = $('#dataTableRefrendos').DataTable({
                ajax: "{{ route('jefatura.refrendos.list') }}",
                serverSide: true,
                processing: true,
                columns: [
                    {data: 'ejercicio', name: 'ejercicio'},
                    {data: 'empresa.rfc_empresa', name: 'rfc_empresa'},
                    {data: 'empresa.nombre_empresa', name: 'nombre_empresa'},
                    {data: 'empresa.nombre_persona', name: 'nombre_persona'},
				...
				<div class="panel-body">
                    ...
                    <div class="row">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTableRefrendos" width="100%" cellspacing="0">
                                <colgroup>
                                    <col style="width: 5%;">
                                    <col style="width: 10%;">
                                    <col style="width: 30%;">
