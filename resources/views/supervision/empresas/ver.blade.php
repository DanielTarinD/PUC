...
$(function () {
    ...
    $("#datepicker-ejercicioFolio").datepicker({
        todayHighlight: true,
        autoclose: true,
        format: "yyyy",
        viewMode: "years",
    ...
    $('#enviar').on('click',function(e){
        ...
        Swal.fire({
                title: "ATENCION !!!",
                text: "La generación de la Constancia le dara un Identificador Único a la empresa para su validación, esta seguro de de esta acción ?",
                icon: "warning",
    ...
    $('#cambiarEstatus').on('click',function(e){
        e.preventDefault();
        var form = $(this).parents('form');
        Swal.fire({
                title: "ATENCION !!!",
                text: "Cambiar el Estatus puede dar lugar a inconsistencias en los datos que se generan, esta seguro de de esta acción ?",
                icon: "warning",
                showCancelButton: true,
                reverseButtons: true,
                confirmButtonColor: '#d33',
    ...
    $('#constancia').click(function(){
        window.open('/administracion/constancia/ver/'+{{ $empresa->id }});
        return false;
    });
        ...
        <div class="panel panel-inverse" data-sortable-id="index-1">
            ...
            <div class="panel-body">
                ...
                <div class="accordion" id="accordion">
                    ...
                    <form method="POST" action="{{ route('supervision.cambiarEstatus') }}" autocomplete="off" id="formCambiarEstatus" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <select class="form-select" name="motivo_empresa" id="estatus">
                                    <option {{ old('motivo_empresa', $empresa->motivo_empresa) == '1' ? 'selected' : '' }} value="1">Inscripción</option>
                                    <option {{ old('motivo_empresa', $empresa->motivo_empresa) == '2' ? 'selected' : '' }} value="2">Refrendo</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <select class="form-select" name="estatus" id="estatus">
                                    <option {{ old('estatus', $empresa->estatus) == 'R' ? 'selected' : '' }} value="R">En Revisión</option>
                                    <option {{ old('estatus', $empresa->estatus) == 'O' ? 'selected' : '' }} value="O">Observada</option>
                                    <option {{ old('estatus', $empresa->estatus) == 'V' ? 'selected' : '' }} value="V">Validada</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-top: 15px;">
                            <div class="d-flex justify-content-end">
                                ...
                                <button type="submit" id="cambiarEstatus" class="btn btn-red w-100px">Actualizar</button>
                    ...
                    <form method="POST" action="{{ route('supervision.constancia') }}" autocomplete="off" id="formGenerarConstancia" enctype="multipart/form-data">
                        @csrf
                        ...
                        <fieldset>
                            ...
                            <div class="row mb-3">
                                <label class="form-label col-form-label col-md-3">Ejercicio del Folio de Jefatura</label>
                                <div class="col-md-9">
                                    <select class="form-select" name="ejercicio_folio_jefatura" id="ejercicio_folio_jefatura">
                                        <option {{ old('fecha_expedicion', isset($empresa->folio->folio_jefatura)?substr($empresa->folio->folio_jefatura, -4):'') == '2022' ? 'selected' : '' }} value="2022">2022</option>
                                        <option {{ old('fecha_expedicion', isset($empresa->folio->folio_jefatura)?substr($empresa->folio->folio_jefatura, -4):'') == '2023' ? 'selected' : '' }} value="2023">2023</option>
                                        <option {{ old('fecha_expedicion', isset($empresa->folio->folio_jefatura)?substr($empresa->folio->folio_jefatura, -4):'') == '2024' ? 'selected' : '' }} value="2024">2024</option>
                                        <option {{ old('fecha_expedicion', isset($empresa->folio->folio_jefatura)?substr($empresa->folio->folio_jefatura, -4):'') == '2025' ? 'selected' : '' }} value="2025">2025</option>
                                    </select>
                            ...
                            <div class="row mb-3">
                                <label class="form-label col-form-label col-md-3">Ejercicio del Folio del Padrón</label>
                                <div class="col-md-9">
                                    <select class="form-select" name="ejercicio_folio" id="ejercicio_folio">
                                        <option {{ old('fecha_expedicion', isset($empresa->folio->folio)?substr($empresa->folio->folio, -4):'') == '2022' ? 'selected' : '' }} value="2022">2022</option>
                                        <option {{ old('fecha_expedicion', isset($empresa->folio->folio)?substr($empresa->folio->folio, -4):'') == '2023' ? 'selected' : '' }} value="2023">2023</option>
                                        <option {{ old('fecha_expedicion', isset($empresa->folio->folio)?substr($empresa->folio->folio, -4):'') == '2024' ? 'selected' : '' }} value="2024">2024</option>
                                        <option {{ old('fecha_expedicion', isset($empresa->folio->folio)?substr($empresa->folio->folio, -4):'') == '2025' ? 'selected' : '' }} value="2025">2025</option>
                                    </select>
