        ...
        <div class="panel panel-inverse" data-sortable-id="index-1">
            ...
            <div class="panel-body">
                ...
                <b>Observaciones de Administración: </b>
                    <div class="row">
                        <div class="col-md-12">
                            <textarea name="observacion" id="editorAdministracion" placeholder="{{ isset($refrendo->observacion) ? $refrendo->observacion : 'Administración no ha hecho alguna Observación' }}">
                                {{ isset($refrendo->observacion) ? $refrendo->observacion : '' }}
                            </textarea>
                            <script>
                                window.addEventListener("load", (e)=>{
                                    ...
                                    .then( editor => {
                                        editor.isReadOnly; // `false`.
                                                        editor.enableReadOnlyMode( '#editorAdministracion' );
                                                        const toolbarElement = editor.ui.view.toolbar.element;
                                                        toolbarElement.style.display = 'none';
                                    } )
                                    .catch( error => {
            ...
            <form method="POST" action="{{ route('supervision.cambiarEstatus.refrendos') }}" autocomplete="off" id="formCambiarEstatus" enctype="multipart/form-data">
            ...
            <br />
                    <form method="POST" action="{{ route('supervision.constancia.refrendos') }}" autocomplete="off" id="formGenerarConstancia" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="ejercicio_folio_jefatura" id="ejercicio_folio_jefatura">
                                        <option {{ old('fecha_expedicion', isset($refrendo->folio_jefatura)?substr($refrendo->folio_jefatura, -4):'') == '2022' ? 'selected' : '' }} value="2022">2022</option>
                                        <option {{ old('fecha_expedicion', isset($refrendo->folio_jefatura)?substr($refrendo->folio_jefatura, -4):'') == '2023' ? 'selected' : '' }} value="2023">2023</option>
                                        <option {{ old('fecha_expedicion', isset($refrendo->folio_jefatura)?substr($refrendo->folio_jefatura, -4):'') == '2024' ? 'selected' : '' }} value="2024">2024</option>
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <select class="form-select" name="ejercicio_folio" id="ejercicio_folio">
                                        <option {{ old('fecha_expedicion', $refrendo->ejercicio == '2022' ? 'selected' : '') }} value="2022" >2022</option>
                                        <option {{ old('fecha_expedicion', $refrendo->ejercicio == '2023' ? 'selected' : '') }} value="2023" >2023</option>
                                    </select>
...
-->
                            ...
                            @if (isset($refrendo->folio_jefatura))
                                ...
                                @if (isset($refrendo->constancia_digitalizada))
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-2">
                                                <a href='{{ asset('storage/refrendos/2023/'.$refrendo->constancia_digitalizada) }}' target='_blank' class='btn btn-xs btn-primary w-30px me-1'><i class='fas fa-file-pdf'></i></a>
                                            </div>
                                        </div>
                                @else
                            ...
                            <div class="row" style="margin-top: 15px;">
                                <div class="d-flex justify-content-end">
                                        ...
                                        <button type="submit" id="btnActualizar" class="btn btn-red w-100px">{{ isset($refrendo->folio_jefatura) ? 'Actualizar' : 'Generar'  }}</button>
