			...
			<div class="panel panel-inverse" data-sortable-id="index-1">
				...
				<div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="d-flex flex-column align-items-center text-center py-5">
                                    ...
                                    <span class="text-black-50">
                                        @forelse ($perfil->roles->take(1) as $role)
                                            {{$role->name}}
                                        @empty
                                            Sin Asginar Rol
                                        @endforelse
                            ...
                            <div class="col-md-6">
                                <form action="/supervisor/perfil" method="POST" autocomplete="off">
                                    @csrf
                                    <div class="p-3 py-5">
                                        ...
                                        <input type="hidden" name="identificador" value="{{ $perfil->id }}">

                                        <div class="row mt-2">
                                            <div class="col-md-6"><label class="labels">RFC Empresa</label><input type="text" class="form-control" placeholder="RFC" name="rfc_empresa" value="{{ $empresa->rfc_empresa }}"></div>
                                        </div>

                                        <div class="row mt-2">
                                            <div class="col-md-6"><label class="labels">Nombre/Empresa</label><input type="text" class="form-control" placeholder="Nombre" name="nombre" value="{{ $empresa->tipo == '1' ? $empresa->nombre_empresa : $empresa->nombre_persona  }}"></div>
                                        </div>

                                        <div class="row mt-3">
                                            <div class="col-md-6"><label class="labels">Correo</label><input type="text" class="form-control" placeholder="Correo Electrónico" name="email" value="{{ $perfil->email }}"></div>
                                        </div>
