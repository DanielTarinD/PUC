...
@section('title', 'Entidades Ejecutoras')
...
$(function () {
	...
	var table = $('#dataTableEntidadesEjecutoras').DataTable({
                ajax: "{{ route('entidadesEjecutoras.list') }}",
                serverSide: true,
                processing: true,
                columns: [
...
@section('content')
	...
	<ol class="breadcrumb float-xl-end">
		...
		<li class="breadcrumb-item active">Entidades Ejecutoras</li>
	</ol>
	<!-- END breadcrumb -->


	<!-- BEGIN page-header -->
	<h1 class="page-header">Entidades Ejecutoras <small>Lista</small></h1>
	<!-- END page-header -->
        ...
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="index-1">
                <div class="panel-heading">
                    <h4 class="panel-title">Entidades Ejecutoras</h4>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="widget widget-stats bg-teal">
                                ...
                                <div class="stats-content">
                                    <div class="stats-title">Entidades Ejecutoras</div>
                                    <div class="stats-number">{{ $totalEntidadesEjecutoras }}</div>
                                    <div class="stats-link">
                                        <a href="/catalogos/entidadesejecutoras/create" class="btn btn-primary">Nueva E. E. <i class="fa fa-arrow-alt-circle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
			...
			<div class="panel panel-inverse" data-sortable-id="index-1">
				...
				<div class="panel-body">
					...
					<div class="table-responsive">
						<table class="table table-bordered" id="dataTableEntidadesEjecutoras" width="100%" cellspacing="0">
							<colgroup>
								<col style="width: 30%;">
								<col style="width: 15%;">
								<col style="width: 40%;">
