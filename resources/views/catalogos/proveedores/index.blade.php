...
$(function () {
	...
	var table = $('#dataTableProveedores').DataTable({
                ...
                processing: true,
                columns: [
                    {data: 'entidad_ejecutora.nombre', name: 'entidad_ejecutora.nombre'},
                    {data: 'rfc', name: 'rfc'},
                    {data: 'nombre', name: 'nombre'},
                    {data: 'representante_legal', name: 'representante_legal'},
					{data: 'direccion_fiscal', name: 'direccion_fiscal'},
...
@section('content')
	...
	<!-- BEGIN page-header -->
	<h1 class="page-header">Proveedores <small>Lista</small></h1>
	<!-- END page-header -->
						...
						<div class="col-xl-3 col-md-6">
							<div class="widget widget-stats bg-teal">
								...
								<div class="stats-content">
									<div class="stats-title">Proveedores</div>
									<div class="stats-number">{{ $totalProveedores }}</div>
									<div class="stats-link">
										<a href="/catalogos/proveedores/create" class="btn btn-primary">Nuevo Proveedor <i class="fa fa-arrow-alt-circle-right"></i></a>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="panel-body">
					...
					<div class="table-responsive">
						<table class="table table-bordered" id="dataTableProveedores" width="100%" cellspacing="0">
							...
							<thead>
								<tr>
                                    <th style="text-align:center">Entidad Ejecutora</th>
