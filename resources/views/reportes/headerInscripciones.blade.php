<div class="page-header">
    <div class="section">
        <div class="d-flex align-items-center">
            ...
            <div style="text-align: left; "><img src="{{ asset('/constancia/Gobierno_Logo_Transparente.png') }}" width="60%" height="60%" alt=""/></div>

            <div style="text-align: right; "><img src="{{ asset('/constancia/SDUOPOT_Logo_Transparente.png') }}" width="60%" height="60%" alt=""/></div>
    ...
    <div class="row primer parrafo">
        <div class="text-center" style="font-size:10px;"><br /><p>
    ...
    <div class="row segundo parrafo">
        <div class="text-center" style="font-size:10px;">
            <p>RELACIÓN DE EMPRESAS QUE REALIZARON SU INSCRIPCIÓN EN EL PADRÓN DE CONTRATISTAS EN EL PERIODO 2022-2023.</p>
