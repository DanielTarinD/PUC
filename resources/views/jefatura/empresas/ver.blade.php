        ...
        <div class="panel panel-inverse" data-sortable-id="index-1">
            ...
            <div class="panel-body">
                ...
                <div class="accordion" id="accordion">
                    ...
                    <form method="POST" action="{{ route('jefatura.constancia') }}" autocomplete="off" id="formGenerarConstancia" enctype="multipart/form-data">
                        @csrf
                        <fieldset>
                            @if ($errors->any())
                            ...
                            @if($empresa->folio()->count() > 0)
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input name="impreso" class="form-check-input" type="checkbox" {{ isset($empresa->folio->estatus) ? 'checked' : ''  }} id="impreso" />
                                    </div>
                                </div>
                            @endif
