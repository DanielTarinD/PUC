<form method="POST" action="{{ route('empresa.gralFisica.update') }}" autocomplete="off" id="formInformacionGeneral">
    @csrf
    <fieldset>
        @if ($errors->any())
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="nombre_persona" value="{{ old('nombre_persona', $empresa->nombre_persona) }}" placeholder="Nombre de la Persona Física con Actividad Empresarial" />
            </div>
        </div>

        <div class="row mb-3">
            <label class="form-label col-form-label col-md-3">Cargo de la Persona Física</label>
            <div class="col-md-9">
                <input type="text" class="form-control" name="cargo_persona" value="{{ old('cargo_persona', $empresa->cargo_persona) }}" placeholder="Cargo de la Persona Física con Actividad Empresarial" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_acta" value="{{ old('link_acta', $empresa->link_acta) }}" placeholder="Acta de Nacimiento y CURP" />
            </div>
        </div>
