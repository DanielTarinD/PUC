<form method="POST" action="{{ route('empresa.general.store') }}" autocomplete="off" id="formInformacionGeneral">
    @csrf
    <fieldset>
        @if ($errors->any())
        ...
        <input type="hidden" class="form-control" name="tipo" value="{{ $tipo }}" readonly />
        <input type="hidden" class="form-control" name="nombre_empresa" value="N/A" readonly />
        <input type="hidden" class="form-control" name="telefono_representante" value="N/A" readonly />
        <input type="hidden" class="form-control" name="email_representante" value="N/A" readonly />
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <select class="form-select" name="motivo_empresa" id="motivo_empresa">
                    ...
                    <option {{ old('motivo_empresa') == 1 ? 'selected' : '' }}  value="1">Inscripción</option>
                </select>
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="enlace_refrendo" value="{{ old('enlace_refrendo') }}" placeholder="Enlace al Registro o Refrendo anterior." />
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            <label class="form-label col-form-label col-md-3">Nombre de la Persona Física</label>
            <div class="col-md-9">
                <input type="text" class="form-control" name="nombre_persona" value="{{ old('nombre_persona') }}" placeholder="Nombre de la Persona Física con Actividad Empresarial" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="cargo_persona" value="{{ old('cargo_persona') }}" placeholder="Cargo de la Persona Física con Actividad Empresarial" />
            </div>
        </div>

        <div class="row mb-3">
            <label class="form-label col-form-label col-md-3">Link a o las Actas <i class="fas fa-circle-info" data-toggle="tooltip" title='Acta de Nacimiento y CURP. *Presentar Original para cotejo.'></i></label>
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_acta" value="{{ old('link_acta') }}" placeholder="Acta de Nacimiento y CURP" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_cv" value="{{ old('link_cv') }}" placeholder="Link al Curriculum de la Persona o Empresa" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="domicilio" value="{{ old('domicilio') }}" placeholder="Calle y Número" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            <label class="form-label col-form-label col-md-3">Link al escrito que manifieste el domicilio en el Estado <i class="fas fa-circle-info" data-toggle="tooltip" title='Escrito en el que manifieste el domicilio en el Estado de Guerrero para oír y recibir todo tipo de notificación, así como mencionar números telefónicos y correo electrónico de la empresa
                - Comprobante del mismo con antigüedad menor de tres meses a nombre de la empresa o el Representante Legal (De lo contrario anexar Contrado de Arrendamiento)
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_domicilio" value="{{ old('link_domicilio') }}" placeholder="Link al escrito que manifieste el domicilio en el Estado" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_domicilio_fiscal" value="{{ old('link_domicilio_fiscal') }}" placeholder="Documento de apertura de sucursal y/o establecimiento en el Estado" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="telefono" value="{{ old('telefono') }}" placeholder="Teléfono de la Empresa" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="Correo de la Empresa" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="url_empresa" value="{{ old('url_empresa') }}" placeholder="URL de la Empresa" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="imss" value="{{ old('imss') }}" placeholder="Registro IMSS" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_registro" value="{{ old('link_registro') }}" placeholder="Link al documento del Registro del IMSS" />
            </div>
        </div>

        <div class="row mb-3">
            <label class="form-label col-form-label col-md-3">Folio de la Constancia de Capacitación</label>
            <div class="col-md-9">
                <input type="text" class="form-control" name="folio_capacitacion" value="{{ old('folio_capacitacion') }}" placeholder="Folio/Número de Constancia de Capacitación" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="nombre_expide" value="{{ old('nombre_expide') }}" placeholder="Nombre de quien Expide la Constancia" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_constancia" value="{{ old('link_constancia') }}" placeholder="Link a la Constancia de Capacitación" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <select class="form-select" name="estratificacion" id="estratificacion">
                    <option value="" disabled selected>Seleccione una Opción</option>
                    <option {{ old('estratificacion') == 1 ? 'selected' : '' }}  value="1">Micro</option>
                    <option {{ old('estratificacion') == 2 ? 'selected' : '' }} value="2">Pequeña</option>
                    <option {{ old('estratificacion') == 3 ? 'selected' : '' }} value="3">Mediana</option>
                </select>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_estratificacion" value="{{ old('link_estratificacion') }}" placeholder="Link al Documento que Acredite la Estratificacíon" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_solicitud" value="{{ old('link_solicitud') }}" placeholder="Link al Documento donde se Solicita la Inscripcion al Padrón de Contratistas" />
            </div>
        </div>
