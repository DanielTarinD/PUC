<form method="POST" action="{{ route('empresa.tecnica.update') }}" autocomplete="off" id="formInformacionTecnica">
    @csrf
    <fieldset>
        @if ($errors->any())
        ...
        <input type="hidden" class="form-control" name="tecnica_id" value="{{ $empresa->tecnicas->id }}" readonly />
        <div class="row mb-3">
            <label class="form-label col-form-label col-md-3">Nombre del Representante Técnico</label>
            <div class="col-md-9">
                <input type="text" class="form-control" name="nombre_representante" value="{{ old('nombre_representante', $empresa->tecnicas->nombre_representante) }}" placeholder="Nombre del Representante Técnico"/>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="cedula_representante" value="{{ old('cedula_representante', $empresa->tecnicas->cedula_representante) }}" placeholder="Número de Cedula del Representante Técnico" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_aceptacion" value="{{ old('link_aceptacion', $empresa->tecnicas->link_aceptacion) }}" placeholder="Link al documento de Aceptación de Representante Técnico" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="anexo_maquinaria" value="{{ old('anexo_maquinaria', $empresa->tecnicas->anexo_maquinaria) }}" placeholder="Link a las Facturas y/o Contratos" />
            </div>
        </div>
