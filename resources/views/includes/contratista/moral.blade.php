<form method="POST" action="{{ route('empresa.general.store') }}" autocomplete="off" id="formInformacionGeneral">
    ...
    <fieldset>
        ...
        <input type="hidden" class="form-control" name="nombre_persona" value="N/A" readonly />
        <input type="hidden" class="form-control" name="cargo_persona" value="N/A" readonly />
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="nombre_empresa" value="{{ old('nombre_empresa') }}" placeholder="Nombre de la Empresa" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_acta" value="{{ old('link_acta') }}" placeholder="Acta Constitutiva debidamente inscrita en el Registro Público de la Propiedad" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="telefono_representante" value="{{ old('telefono_representante') }}" placeholder="Teléfono del Representante Legal" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="email" class="form-control" name="email_representante" value="{{ old('email_representante') }}" placeholder="Correo Representante" />
            </div>
        </div>
