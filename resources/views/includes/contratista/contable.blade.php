<form method="POST" action="{{ route('empresa.contable.store') }}" autocomplete="off" id="formInformacionContable">
    @csrf
    <fieldset>
        @if ($errors->any())
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="capital_contable" value="{{ old('capital_contable') }}" placeholder="Capital Contable"/>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="balance_contable" value="{{ old('balance_contable') }}" placeholder="Capital Contable del Balance General" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="nombre_contador" value="{{ old('nombre_contador') }}" placeholder="Nombre de quien emitio el Balance General" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="fecha_balance_general" value="{{ old('fecha_balance_general') }}" id="datepicker-fechaBalance" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="folio_opinion" value="{{ old('folio_opinion') }}" placeholder="Folio de Opinión de cumplimiento de la 32D" />
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="link_declaracion" value="{{ old('link_declaracion') }}" placeholder="Link a la Declaración Fiscal" />
            </div>
        </div>
