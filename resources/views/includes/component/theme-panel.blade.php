...
<div class="theme-panel">
	...
	<div class="theme-panel-content" data-scrollbar="true" data-height="100%">
		...
		<div class="theme-list">
			<div class="theme-list-item active"><a href="javascript:;" class="theme-list-link bg-red" data-theme-class="theme-red" data-toggle="theme-selector" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-container="body" data-bs-title="Red">&nbsp;</a></div>
			...
			<div class="theme-list-item"><a href="javascript:;" class="theme-list-link bg-teal" data-theme-class="" data-toggle="theme-selector" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-container="body" data-bs-title="Default">&nbsp;</a></div>
			...
			<div class="col-8 control-label text-dark fw-bold">
				...
				<div class="lh-14">
					<small class="text-dark opacity-50">
						Adjusta la apariencia para reducir el brillo y evita el cansancio ocular.
					</small>
				</div>
			</div>
		...
		<div class="theme-panel-divider"></div>
        <center>Derechos Reservados © 2021 - 2027 Secretaría de Desarrollo Urbano, Obras Públicas y Ordenamiento Territorial</center>
	</div>
</div>
<!-- END theme-panel -->
