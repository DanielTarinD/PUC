...
<body>
    <div class="container">
            ...
            <div class="row leyenda">
                <div class="fecha" style="text-align:right; font-size:12px;">Chilpancingo de los Bravo, Gro., a {{ $fechaExpedicion }}
                    ...
                    @elseif (substr($empresa->folio->folio, -4) === '2024')
                        <span   span style="margin-top: 10px; color: #ab0033;"><b>“2024, Año de Felipe Carrillo Puerto, Benemérito del Proletariado, <br />Revolucionario y Defensor del Mayab”</b></span>
            ...
            <div class="row primer-texto">
                <div class="text-block-3" style="font-size:14px;">En atención a su Solicitud y en virtud de haber acreditado lo dispuesto en el artículo 31 de La Ley de Obras Públicas y sus Servicios del Estado de Guerrero número 266, hace de su conocimiento que la <i>Secretaría de Desarrollo Urbano, Obras Públicas Y Ordenamiento Territorial</i>, ha tenido a bien {{ $empresa->motivo_empresa == '2' ? 'Refrendarlo' : 'Registrarlo' }} en el Padrón Único de Contratistas del Gobierno del Estado de Guerrero, con el número <b>{{ $empresa->folio->folio }}</b>, y de acuerdo al artículo 30 de la ley en mención, se le asignan la (s) especialidad (es) número(s):</div>
            </div>
            ...
            <div style="margin-top: {{ $empresa->especialidades()->count() > 6 ? 15 : 60 }}px;font-size:16px; text-align: center;">
