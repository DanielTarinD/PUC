                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-md-6">
                        <div class="widget widget-stats sdupot-color">
                            ...
                            <div class="stats-info">
                                <p>
                                    {{ $empresa->tipo == "1" ? $empresa->nombre_empresa : $empresa->nombre_persona }} - Revisión
                                </p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <textarea name="obras" id="editorObras">
                            {{ isset($empresa->observaciones->obras)? $empresa->observaciones->obras : 'El Área de Padrón no ha hecho alguna Observación' }}
                        </textarea>
                        <script>
