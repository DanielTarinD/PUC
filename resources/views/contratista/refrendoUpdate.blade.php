    ...
    <div class="col-xl-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="index-1">
            <div class="panel-heading">
                <h4 class="panel-title">Notas hechas por el area del Padrón:</h4>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="d-flex">
                        <h4>Notas hechas por el área del Padrón:</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <textarea name="nota_padron" id="nota_padron">
                            {{ isset($refrendo->observacionesRefrendos->obras) ? $refrendo->observacionesRefrendos->obras : 'No existen observaciones.' }}
                        </textarea>
                        <script>
                            window.addEventListener("load", (e)=>{

                                    ClassicEditor.create( document.querySelector( '#nota_padron' ),{
                                    })
                                    .then(editor => {
                                        editor.isReadOnly; // `false`.
                                            editor.enableReadOnlyMode( '#nota_padron' );
...
<div class="row">
    ...
    <div class="col-xl-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="index-1">
            ...
            <div class="panel-body">
                <form method="POST" action="{{ route('empresa.refrendo.update') }}" autocomplete="off" id="formRefrendo">
                    @csrf
                    <fieldset>
                        ...
                        <input type="hidden" class="form-control" name="ejercicio" value="{{ $refrendo->ejercicio }}" readonly />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="solicitud_refrendo" value="{{ old('solicitud_refrendo', $refrendo->solicitud_refrendo) }}"  placeholder="Enlace a la Solicitud de Refrendo"/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="acta_refrendo" value="{{ old('acta_refrendo', $refrendo->acta_refrendo) }}"  placeholder="Enlace al Acta Constitutiva. (En caso de que exista algún cambio de Administración en la Empresa Moral)"/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="representante_refrendo" value="{{ old('representante_refrendo', $refrendo->representante_refrendo) }}"  placeholder="Solo en caso de haber cambiado el representante legal, deberán anotar el nombre del nuevo representante (texto)."/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="domicilio_refrendo" value="{{ old('domicilio_refrendo', $refrendo->domicilio_refrendo) }}"  placeholder=" Enlace al Comprobante de Domicilio. (En caso de que exista un cambio de Domicilio para oír y recibir notificaciones)."/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <select class="form-select" name="estado_id" id="estado_id">
                                    <option value="{{ $refrendo->estado_id}}" selected>{{ isset($refrendo->estado->nombre) ? $refrendo->estado->nombre :  'Seleccione un Estado'}}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <select class="form-select" name="municipio_id" id="municipio_id">
                                    <option value="{{ $refrendo->municipio_id}}" selected>{{ isset($refrendo->municipio->nombre) ? $refrendo->municipio->nombre : '' }}</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <select class="form-select" name="localidad_id" id="localidad_id">
                                    <option value="{{ $refrendo->localidad_id}}" selected>{{ isset($refrendo->localidad->nombre) ? $refrendo->localidad->nombre : ''  }}</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="colonia" value="{{ old('colonia', $refrendo->colonia) }}" placeholder="Colonia" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="domicilio_texto_refrendo" value="{{ old('domicilio_texto_refrendo', $refrendo->domicilio_texto_refrendo) }}" placeholder="Calle y Número" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="codigo_postal" value="{{ old('codigo_postal', $refrendo->codigo_postal) }}" placeholder="Código Postal" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="pagina_refrendo" value="{{ old('pagina_refrendo', $refrendo->pagina_refrendo) }}"  placeholder="Enlace a la Página web del contratista"/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="constancia_refrendo" value="{{ old('constancia_refrendo', $refrendo->constancia_refrendo) }}"  placeholder="Enlace a la Constancia de capacitación"/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="estratificacion_refrendo" value="{{ old('estratificacion_refrendo', $refrendo->estratificacion_refrendo) }}"  placeholder="Enlace al Documento de estratificación"/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="declaracion_refrendo" value="{{ old('declaracion_refrendo', $refrendo->declaracion_refrendo) }}"  placeholder="Enlace a la Declaración fiscal"/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="maquinaria_refrendo" value="{{ old('maquinaria_refrendo', $refrendo->maquinaria_refrendo) }}"  placeholder="Enlace a las Facturas de maquinaria y equipo"/>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <textarea name="nota_refrendo" id="nota_refrendo">
                                    {{ old('nota_refrendo', $refrendo->nota_refrendo) }}
                                </textarea>
                                <script>
                                    window.addEventListener("load", (e)=>{
