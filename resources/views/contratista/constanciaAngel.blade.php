...
<html>
    ...
    <style>
        ...
        ul{
                list-style-image: url('/constancia/bullet.png');
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-6" style="text-align: center;">
                    <img class="qr" src='data:image/png;base64, {!! base64_encode(QrCode::format('png')->merge('https://padron.sduopotguerrero.com/constancia/jaguar.png', .2, true)->size(150)->generate('https://padron.sduopotguerrero.com/validacion/'.$empresa->folio->uuid.'/'.$empresa->rfc_empresa)) !!} '>
                </div>
                        <div class="col-6">
                        ...
                        <div class="row leyenda">
                            <div class="fecha" style="text-align:right; font-size:12px;">Chilpancingo de los Bravo, Gro., a {{ $fechaExpedicion }}
                                <br/>
                                <span style="margin-top: 10px; color: #ab0033;"><b>“2022, Año de Ricardo Flores Magón”</b></span>
                                @if ($empresa->motivo_empresa == '2')
                                    <br /><br />
                                    <h4>REFRENDO 2022 - 2023</h4>
                                @else
                                    <br /><br />
                                    <h4>INSCRIPCIÓN 2022 - 2023</h4>
                                @endif

                                <span style="text-align:right; font-size:14px; color: #bc955c;"><b>Válido Hasta el 31 de Mayo de 2023.</b><span>
                            </div>
                        </div>
                </div>
            ...
            <div class="row primer-texto">
                <div class="text-block-3" style="font-size:14px;">En atención a su Solicitud y en virtud de haber acreditado lo dispuesto en el articulo 31 de La Ley de Obras Públicas y sus Servicios del Estado de Guerrero número 266, hago de su conocimiento que la Secretaria De Desarrollo Urbano, Obras Publicas Y Ordenamiento Territorial, ha tenido a bien registrarlo en el Padrón de Contratistas del Gobierno del Estado de Guerrero, con el numero <b>{{ $empresa->folio->folio }}</b>, y de acuerdo al articulo 30 de la ley en mención, se le asignan la (s) especialidad (es) número(s):</div>
            </div>
                    ...
                    <ul>
                        ...
                        @foreach ($empresa->especialidades as $especialidad)
                            ...
                            @if(strlen($especialidad->especialidad->nombre) > 35 && $empresa->especialidades()->count() > 4)
                                <li><span class="cuentaMayor" style=" font-size: 16px;"><b>{{ substr($especialidad->especialidad->nombre, 0, 3) }}</b><span style="font-size: 12px;">{{ substr($especialidad->especialidad->nombre, 3) }}</span><span></li>
                            @else
                                <li><span class="cuentaMayor" style=" font-size: 16px;"><b> {{ substr($especialidad->especialidad->nombre, 0, 3) }}</b>{{ substr($especialidad->especialidad->nombre, 3) }}<span></li>
                            @endif
            ...
            <footer>
                ...
                <div class="row">
                    <div class="col-12 ccp fst-italic" style="font-size:6px;">
                        <small>
                ...
                <div class="row" style="margin-top: 10px; font-size:10px;">
                    ...
                    <img style="margin-top: 10px;" src="{{ asset('/constancia/cintillo_delgado.png') }}" alt=""/>
                </div>
