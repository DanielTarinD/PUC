...
$(function () {
    ...
    Swal.fire({
                title: "ATENCION !!!",
                text: "Sus datos para el Refrendo 2024 - 2025 están siendo revisados, recibirá un correo electrónico cuando exista alguna observación o el proceso haya sido completado.",
                icon: "warning",
        });
