...
<body>
    <div class="container">
            ...
            <div class="row primer-texto">
                <div class="text-block-3" style="font-size:12px;">En atención a su Solicitud y en virtud de haber acreditado lo dispuesto en el artículo 31 de La Ley de Obras Públicas y sus Servicios del Estado de Guerrero número 266, hace de su conocimiento que la <i>Secretaría de Desarrollo Urbano, Obras Públicas Y Ordenamiento Territorial</i>, ha tenido a bien Refrendarlo en el Padrón Único de Contratistas del Gobierno del Estado de Guerrero, con el número <b>{{ $refrendo->empresa->folio->folio }}</b>, y de acuerdo al artículo 30 de la ley en mención, se le asignan la (s) especialidad (es) número(s):</div>
            </div>
            ...
            <div style="margin-top: {{ $refrendo->empresa->especialidades()->count() > 6 ? 15 : 60 }}px;font-size:14px; text-align: center;">
            ...
            <footer>
                ...
                <div class="row">
                    <div class="col-9 ccp fst-italic" style="margin-top: 170px;font-size:9px;">
                        <small>
