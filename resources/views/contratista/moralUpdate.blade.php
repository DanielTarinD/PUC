...
@section('content')
	...
	<!-- END breadcrumb -->
	<!-- BEGIN page-header -->
	<h1 class="page-header">Empresa <small> - Persona Moral </small></h1>
	<!-- END page-header -->
    ...
    <div class="col-xl-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="index-1">
            <div class="panel-heading">
                <h4 class="panel-title">Formulario PC-1M - Información General</h4>
            ...
            <div class="panel-body">
                @include('includes.contratista.moralUpdate')
            </div>
        </div>
        <!-- END panel -->
    </div>
