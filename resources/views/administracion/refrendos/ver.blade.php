            ...
            <div class="panel-body">
                ...
                <br />
                    ...
                    @if (isset($refrendo->folio_jefatura))
                        ...
                        <form method="POST" action="{{ route('administracion.constancia.refrendo') }}" autocomplete="off" id="formGenerarConstancia" enctype="multipart/form-data">
                            @csrf

                            <input type="hidden" name="refrendo_id" value="{{ $refrendo->id }}" readonly />
                            <input type="hidden" name="empresa_id" value="{{ $refrendo->empresa->id }}" readonly />
                            <input type="hidden" name="folio_jefatura" value="{{ substr($refrendo->empresa->folio->folio_jefatura, 16, -5) }}" readonly/>
                            <input type="hidden" name="fecha_expedicion" value="{{ $refrendo->empresa->folio->fecha_expedicion }}" readonly />
                            ...
                            <b>Observaciones de Administración: </b>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" value="{{ substr($refrendo->folio_jefatura, 16, -5)  }}" readonly />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" value="{{ $refrendo->fecha_expedicion }}"  readonly/>
                                    </div>
                                </div>
